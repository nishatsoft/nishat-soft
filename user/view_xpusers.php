...
<title><?php include('extension/title.php'); ?> | View Export</title>
...
<!-- main content wrapper start-->
    ...
    <div class="content-wrapper">
      <div class="page-title">
        <div class="row">
          <div class="col-sm-6">
                <h4 class="mb-0"> View Export Users</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right">
              <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
              <li class="breadcrumb-item active">View Export Users</li>
            </ol>
          </div>
        </div>
      </div>
