...
$query = mysqli_query($con,"select user_id, user_name, user_pass, user_duration, is_freeze, user_upline, device_connected, is_active, device_id from users where user_rank='export'");
$totalData = mysqli_num_rows($query);
$totalFiltered = $totalData;

if($mrank=='superadmin'){
    $sql = "select user_id, user_name, user_pass, user_duration, is_freeze, user_upline, device_connected, is_active, device_id from users where user_rank='export'";
}else{
    $sql = "select user_id, user_name, user_pass, user_duration, is_freeze, user_upline, device_connected, is_active, device_id from users where user_rank='export' and user_upline='$userid'";
}
